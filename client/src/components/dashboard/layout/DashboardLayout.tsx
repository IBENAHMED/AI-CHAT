      ...
      <div className={"content"}>
        <div className={"chatList flex flex-col justify-between px-3 bg-[#212121]"} style={{ height:"calc(100vh - 63.98px)"}}>
          <div>
            ...
            <ul className={"mt-1.5"}>
              <li className={"text-white text-sm hover:bg-[#eee] rounded cursor-pointer hover:text-black py-2 px-3"}><Link href="/dashboard">Create a new Chat</Link></li>
              <li className={"text-white text-sm hover:bg-[#eee] rounded cursor-pointer hover:text-black py-2 px-3"}><Link href="/">Explore Lama AI</Link></li>
              <li className={"text-white text-sm hover:bg-[#eee] rounded cursor-pointer hover:text-black py-2 px-3"}><Link href="/">Contact</Link></li>
            </ul>
